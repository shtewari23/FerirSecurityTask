      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-light-bg dark:bg-dark-bg relative">
        ...
        <div className="w-full max-w-md">
          <div className="bg-white dark:bg-dark-surface rounded-2xl shadow-xl p-8 border border-light-border dark:border-dark-border">
            <h2 className="text-3xl font-bold text-light-text dark:text-dark-text mb-2">Log in</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-light-border dark:border-dark-border text-primary focus:ring-2 focus:ring-primary"
                  />
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-dark-surface text-light-text-secondary dark:text-dark-text-secondary">
                    Or continue with
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  type="button"
                  onClick={() => toast.success('Apple login clicked')}
                  className="flex items-center justify-center py-3 rounded-lg bg-black hover:bg-gray-900 text-white transition-colors"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center py-3 rounded-lg border-2 border-light-border dark:border-dark-border hover:bg-light-surface dark:hover:bg-dark-bg transition-colors"
                >
                ...
                <button
                  type="button"
                  onClick={() => toast.success('Meta login clicked')}
                  className="flex items-center justify-center py-3 rounded-lg bg-blue-600 hover:bg-blue-700 text-white transition-colors"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
